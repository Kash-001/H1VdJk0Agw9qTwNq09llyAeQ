...
local Themes = {
	...
	Dark = {
		...
		Maximise = Color3.fromRGB(0, 0, 0),
		MaximiseAccent = Color3.fromRGB(255, 255, 255),
		NavBar = Color3.fromRGB(90, 0, 0),
		NavBarAccent = Color3.fromRGB(0, 0, 0),
		NavBarInvert = Color3.fromRGB(235,235,235),
		TitleBar = Color3.fromRGB(90, 0, 0),
		TitleBarAccent = Color3.fromRGB(0, 0, 0),
		Overlay = Color3.fromRGB(90, 0, 0),
		Banner = Color3.fromRGB(90, 0, 0),
		BannerAccent = Color3.fromRGB(0, 0, 0),
		Content = Color3.fromRGB(95, 95, 95),
		Button = Color3.fromRGB(0, 0, 0),
		ButtonAccent = Color3.fromRGB(90, 0, 0),
		ChipSet = Color3.fromRGB(0, 0, 0),
		ChipSetAccent = Color3.fromRGB(90, 0, 0),
		DataTable = Color3.fromRGB(0, 0, 0),
		DataTableAccent = Color3.fromRGB(90, 0, 0),
		Slider = Color3.fromRGB(0, 0, 0),
		SliderAccent = Color3.fromRGB(90, 0, 0),
		Toggle = Color3.fromRGB(0, 0, 0),
		ToggleAccent = Color3.fromRGB(0, 0, 0),
		Dropdown = Color3.fromRGB(0, 0, 0),
		DropdownAccent = Color3.fromRGB(90, 0, 0),
		ColorPicker = Color3.fromRGB(0, 0, 0),
		ColorPickerAccent = Color3.fromRGB(90, 0, 0),
		TextField = Color3.fromRGB(0, 0, 0),
		TextFieldAccent = Color3.fromRGB(90, 0, 0),
	},
    Mauve = {
        MainFrame = Color3.fromRGB(187, 133, 171),
        Minimise = Color3.fromRGB(187, 133, 171),
        MinimiseAccent = Color3.fromRGB(255, 255, 255),
        Maximise = Color3.fromRGB(187, 133, 171),
        MaximiseAccent = Color3.fromRGB(255, 255, 255),
        NavBar = Color3.fromRGB(167, 103, 151),
        NavBarAccent = Color3.fromRGB(255, 255, 255),
        NavBarInvert = Color3.fromRGB(235, 235, 235),
        TitleBar = Color3.fromRGB(187, 133, 171),
        TitleBarAccent = Color3.fromRGB(255, 255, 255),
        Overlay = Color3.fromRGB(187, 133, 171),
        Banner = Color3.fromRGB(187, 133, 171),
        BannerAccent = Color3.fromRGB(255, 255, 255),
        Content = Color3.fromRGB(197, 143, 181),
        Button = Color3.fromRGB(187, 133, 171),
        ButtonAccent = Color3.fromRGB(167, 113, 151),
        ChipSet = Color3.fromRGB(187, 133, 171),
        ChipSetAccent = Color3.fromRGB(255, 255, 255),
        DataTable = Color3.fromRGB(187, 133, 171),
        DataTableAccent = Color3.fromRGB(255, 255, 255),
        Slider = Color3.fromRGB(187, 133, 171),
        SliderAccent = Color3.fromRGB(167, 113, 151),
        Toggle = Color3.fromRGB(187, 133, 171),
        ToggleAccent = Color3.fromRGB(255, 255, 255),
        Dropdown = Color3.fromRGB(187, 133, 171),
        DropdownAccent = Color3.fromRGB(167, 113, 151),
        ColorPicker = Color3.fromRGB(187, 133, 171),
        ColorPickerAccent = Color3.fromRGB(255, 255, 255),
        TextField = Color3.fromRGB(187, 133, 171),
