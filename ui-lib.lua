...
local Themes = {
    ...
    Neon = {
        MainFrame = Color3.fromRGB(0, 255, 255),      -- Cyan
        Minimise = Color3.fromRGB(255, 20, 147),      -- Deep Pink
        MinimiseAccent = Color3.fromRGB(255, 105, 180), -- Hot Pink
        Maximise = Color3.fromRGB(50, 205, 50),       -- Lime Green
        MaximiseAccent = Color3.fromRGB(0, 255, 127), -- Spring Green
        NavBar = Color3.fromRGB(148, 0, 211),         -- Dark Violet
        NavBarAccent = Color3.fromRGB(255, 255, 255), -- White
        NavBarInvert = Color3.fromRGB(30, 30, 30),    -- Dark Gray
        TitleBar = Color3.fromRGB(0, 191, 255),       -- Deep Sky Blue
        TitleBarAccent = Color3.fromRGB(255, 255, 255), -- White
        Overlay = Color3.fromRGB(124, 37, 255),       -- Bright Purple
        Banner = Color3.fromRGB(255, 255, 255),       -- White
        BannerAccent = Color3.fromRGB(0, 191, 255),   -- Deep Sky Blue
        Content = Color3.fromRGB(0, 255, 255),        -- Cyan
        Button = Color3.fromRGB(50, 205, 50),         -- Lime Green
        ButtonAccent = Color3.fromRGB(255, 255, 255), -- White
        ChipSet = Color3.fromRGB(0, 255, 127),        -- Spring Green
        ChipSetAccent = Color3.fromRGB(255, 255, 255), -- White
        DataTable = Color3.fromRGB(0, 255, 255),      -- Cyan
        DataTableAccent = Color3.fromRGB(255, 255, 255), -- White
        Slider = Color3.fromRGB(255, 255, 255),       -- White
        SliderAccent = Color3.fromRGB(0, 255, 127),   -- Spring Green
        Toggle = Color3.fromRGB(50, 205, 50),         -- Lime Green
        ToggleAccent = Color3.fromRGB(255, 255, 255), -- White
        Dropdown = Color3.fromRGB(0, 255, 255),       -- Cyan
        DropdownAccent = Color3.fromRGB(255, 20, 147), -- Deep Pink
        ColorPicker = Color3.fromRGB(255, 255, 255),  -- White
        ColorPickerAccent = Color3.fromRGB(148, 0, 211), -- Dark Violet
        TextField = Color3.fromRGB(148, 0, 211),      -- Dark Violet
        TextFieldAccent = Color3.fromRGB(255, 255, 255), -- White
    },
    Hell = {
        MainFrame = Color3.fromRGB(30, 30, 30),       -- Black
        Minimise = Color3.fromRGB(255, 69, 0),        -- Red-Orange
        MinimiseAccent = Color3.fromRGB(255, 140, 0), -- Dark Orange
        Maximise = Color3.fromRGB(255, 0, 0),         -- Red
        MaximiseAccent = Color3.fromRGB(139, 0, 0),   -- Dark Red
        NavBar = Color3.fromRGB(255, 69, 0),          -- Red-Orange
        NavBarAccent = Color3.fromRGB(0, 0, 0),       -- Black
        NavBarInvert = Color3.fromRGB(255, 255, 255), -- White
        TitleBar = Color3.fromRGB(255, 0, 0),         -- Red
        TitleBarAccent = Color3.fromRGB(255, 255, 255), -- White
        Overlay = Color3.fromRGB(139, 0, 0),          -- Dark Red
        Banner = Color3.fromRGB(255, 69, 0),          -- Red-Orange
        BannerAccent = Color3.fromRGB(0, 0, 0),       -- Black
        Content = Color3.fromRGB(255, 69, 0),         -- Red-Orange
        Button = Color3.fromRGB(255, 0, 0),           -- Red
        ButtonAccent = Color3.fromRGB(255, 255, 255), -- White
        ChipSet = Color3.fromRGB(255, 69, 0),         -- Red-Orange
        ChipSetAccent = Color3.fromRGB(255, 255, 255), -- White
        DataTable = Color3.fromRGB(139, 0, 0),        -- Dark Red
        DataTableAccent = Color3.fromRGB(255, 255, 255), -- White
        Slider = Color3.fromRGB(255, 140, 0),         -- Dark Orange
        SliderAccent = Color3.fromRGB(255, 69, 0),    -- Red-Orange
        Toggle = Color3.fromRGB(255, 0, 0),           -- Red
        ToggleAccent = Color3.fromRGB(255, 255, 255), -- White
        Dropdown = Color3.fromRGB(139, 0, 0),         -- Dark Red
        DropdownAccent = Color3.fromRGB(255, 140, 0), -- Dark Orange
        ColorPicker = Color3.fromRGB(255, 69, 0),     -- Red-Orange
        ColorPickerAccent = Color3.fromRGB(0, 0, 0),  -- Black
        TextField = Color3.fromRGB(255, 69, 0),       -- Red-Orange
        TextFieldAccent = Color3.fromRGB(255, 255, 255), -- White
    },
    Crypt = {
        MainFrame = Color3.fromRGB(48, 25, 52),       -- Mauve
        Minimise = Color3.fromRGB(138, 43, 226),      -- Blue-Violet
        MinimiseAccent = Color3.fromRGB(75, 0, 130),  -- Indigo
        Maximise = Color3.fromRGB(186, 85, 211),      -- Medium Orchid
        MaximiseAccent = Color3.fromRGB(147, 112, 219), -- Medium Purple
        NavBar = Color3.fromRGB(75, 0, 130),          -- Indigo
        NavBarAccent = Color3.fromRGB(255, 255, 255), -- White
        NavBarInvert = Color3.fromRGB(30, 30, 30),    -- Dark Gray
        TitleBar = Color3.fromRGB(186, 85, 211),      -- Medium Orchid
        TitleBarAccent = Color3.fromRGB(255, 255, 255), -- White
        Overlay = Color3.fromRGB(48, 25, 52),         -- Mauve
        Banner = Color3.fromRGB(138, 43, 226),        -- Blue-Violet
        BannerAccent = Color3.fromRGB(0, 0, 0),       -- Black
        Content = Color3.fromRGB(186, 85, 211),       -- Medium Orchid
        Button = Color3.fromRGB(147, 112, 219),       -- Medium Purple
        ButtonAccent = Color3.fromRGB(255, 255, 255), -- White
        ChipSet = Color3.fromRGB(75, 0, 130),         -- Indigo
        ChipSetAccent = Color3.fromRGB(255, 255, 255), -- White
        DataTable = Color3.fromRGB(138, 43, 226),     -- Blue-Violet
        DataTableAccent = Color3.fromRGB(255, 255, 255), -- White
        Slider = Color3.fromRGB(186, 85, 211),        -- Medium Orchid
        SliderAccent = Color3.fromRGB(138, 43, 226),  -- Blue-Violet
        Toggle = Color3.fromRGB(147, 112, 219),       -- Medium Purple
        ToggleAccent = Color3.fromRGB(255, 255, 255), -- White
        Dropdown = Color3.fromRGB(48, 25, 52),        -- Mauve
        DropdownAccent = Color3.fromRGB(138, 43, 226), -- Blue-Violet
        ColorPicker = Color3.fromRGB(75, 0, 130),     -- Indigo
        ColorPickerAccent = Color3.fromRGB(255, 255, 255), -- White
        TextField = Color3.fromRGB(186, 85, 211),     -- Medium Orchid
        TextFieldAccent = Color3.fromRGB(255, 255, 255), -- White
    },
    Raven = {
        MainFrame = Color3.fromRGB(15, 15, 15),       -- Black
        Minimise = Color3.fromRGB(80, 80, 80),        -- Dark Grey
        MinimiseAccent = Color3.fromRGB(50, 50, 50),  -- Charcoal Grey
        Maximise = Color3.fromRGB(100, 100, 100),     -- Medium Grey
        MaximiseAccent = Color3.fromRGB(80, 80, 80),  -- Dark Grey
        NavBar = Color3.fromRGB(30, 30, 30),          -- Very Dark Grey
        NavBarAccent = Color3.fromRGB(255, 255, 255), -- White
        NavBarInvert = Color3.fromRGB(10, 10, 10),    -- Almost Black
        TitleBar = Color3.fromRGB(40, 40, 40),        -- Dark Grey
        TitleBarAccent = Color3.fromRGB(150, 150, 150), -- Light Grey
        Overlay = Color3.fromRGB(20, 20, 20),         -- Blackish Grey
        Banner = Color3.fromRGB(80, 80, 80),          -- Dark Grey
        BannerAccent = Color3.fromRGB(50, 50, 50),    -- Charcoal Grey
        Content = Color3.fromRGB(15, 15, 15),         -- Black
        Button = Color3.fromRGB(100, 100, 100),       -- Medium Grey
        ButtonAccent = Color3.fromRGB(150, 150, 150), -- Light Grey
        ChipSet = Color3.fromRGB(50, 50, 50),         -- Charcoal Grey
        ChipSetAccent = Color3.fromRGB(200, 200, 200), -- Silver
        DataTable = Color3.fromRGB(30, 30, 30),       -- Very Dark Grey
        DataTableAccent = Color3.fromRGB(100, 100, 100), -- Medium Grey
        Slider = Color3.fromRGB(80, 80, 80),          -- Dark Grey
        SliderAccent = Color3.fromRGB(150, 150, 150), -- Light Grey
        Toggle = Color3.fromRGB(50, 50, 50),          -- Charcoal Grey
        ToggleAccent = Color3.fromRGB(200, 200, 200), -- Silver
        Dropdown = Color3.fromRGB(40, 40, 40),        -- Dark Grey
        DropdownAccent = Color3.fromRGB(150, 150, 150), -- Light Grey
        ColorPicker = Color3.fromRGB(50, 50, 50),     -- Charcoal Grey
        ColorPickerAccent = Color3.fromRGB(150, 150, 150), -- Light Grey
        TextField = Color3.fromRGB(80, 80, 80),       -- Dark Grey
        TextFieldAccent = Color3.fromRGB(150, 150, 150), -- Light Grey
    },
    Abyss = {
        MainFrame = Color3.fromRGB(10, 10, 40),       -- Deep Midnight Blue
        Minimise = Color3.fromRGB(0, 0, 139),         -- Dark Blue
        MinimiseAccent = Color3.fromRGB(25, 25, 112), -- Midnight Blue
        Maximise = Color3.fromRGB(30, 30, 70),        -- Very Dark Blue
        MaximiseAccent = Color3.fromRGB(0, 0, 205),   -- Medium Blue
        NavBar = Color3.fromRGB(15, 15, 30),          -- Blackish Blue
        NavBarAccent = Color3.fromRGB(255, 255, 255), -- White
        NavBarInvert = Color3.fromRGB(0, 0, 0),       -- Black
        TitleBar = Color3.fromRGB(0, 0, 50),          -- Navy
        TitleBarAccent = Color3.fromRGB(255, 255, 255), -- White
        Overlay = Color3.fromRGB(0, 0, 0),            -- Black
        Banner = Color3.fromRGB(0, 0, 80),            -- Dark Navy
        BannerAccent = Color3.fromRGB(255, 255, 255), -- White
        Content = Color3.fromRGB(15, 15, 30),         -- Blackish Blue
        Button = Color3.fromRGB(25, 25, 112),         -- Midnight Blue
        ButtonAccent = Color3.fromRGB(255, 255, 255), -- White
        ChipSet = Color3.fromRGB(0, 0, 50),           -- Navy
        ChipSetAccent = Color3.fromRGB(255, 255, 255), -- White
        DataTable = Color3.fromRGB(0, 0, 50),         -- Navy
        DataTableAccent = Color3.fromRGB(255, 255, 255), -- White
        Slider = Color3.fromRGB(0, 0, 139),           -- Dark Blue
        SliderAccent = Color3.fromRGB(255, 255, 255), -- White
        Toggle = Color3.fromRGB(30, 30, 70),          -- Very Dark Blue
        ToggleAccent = Color3.fromRGB(255, 255, 255), -- White
        Dropdown = Color3.fromRGB(0, 0, 50),          -- Navy
        DropdownAccent = Color3.fromRGB(255, 255, 255), -- White
        ColorPicker = Color3.fromRGB(0, 0, 139),      -- Dark Blue
        ColorPickerAccent = Color3.fromRGB(255, 255, 255), -- White
        TextField = Color3.fromRGB(0, 0, 139),        -- Dark Blue
        TextFieldAccent = Color3.fromRGB(255, 255, 255), -- White
    },
    Bloodlust = {
        MainFrame = Color3.fromRGB(20, 0, 0),         -- Very Dark Red
        Minimise = Color3.fromRGB(139, 0, 0),         -- Dark Red
        MinimiseAccent = Color3.fromRGB(178, 34, 34), -- Firebrick
        Maximise = Color3.fromRGB(255, 0, 0),         -- Red
        MaximiseAccent = Color3.fromRGB(220, 20, 60), -- Crimson
        NavBar = Color3.fromRGB(0, 0, 0),             -- Black
        NavBarAccent = Color3.fromRGB(255, 255, 255), -- White
        NavBarInvert = Color3.fromRGB(255, 255, 255), -- White
        TitleBar = Color3.fromRGB(139, 0, 0),         -- Dark Red
        TitleBarAccent = Color3.fromRGB(255, 255, 255), -- White
        Overlay = Color3.fromRGB(20, 0, 0),           -- Very Dark Red
        Banner = Color3.fromRGB(178, 34, 34),         -- Firebrick
        BannerAccent = Color3.fromRGB(255, 255, 255), -- White
        Content = Color3.fromRGB(139, 0, 0),          -- Dark Red
        Button = Color3.fromRGB(255, 0, 0),           -- Red
        ButtonAccent = Color3.fromRGB(255, 255, 255), -- White
        ChipSet = Color3.fromRGB(178, 34, 34),        -- Firebrick
        ChipSetAccent = Color3.fromRGB(255, 255, 255), -- White
        DataTable = Color3.fromRGB(139, 0, 0),        -- Dark Red
        DataTableAccent = Color3.fromRGB(255, 255, 255), -- White
        Slider = Color3.fromRGB(220, 20, 60),         -- Crimson
        SliderAccent = Color3.fromRGB(255, 255, 255), -- White
        Toggle = Color3.fromRGB(139, 0, 0),           -- Dark Red
        ToggleAccent = Color3.fromRGB(255, 255, 255), -- White
        Dropdown = Color3.fromRGB(50, 0, 0),          -- Very Dark Red
        DropdownAccent = Color3.fromRGB(255, 255, 255), -- White
        ColorPicker = Color3.fromRGB(255, 0, 0),      -- Red
        ColorPickerAccent = Color3.fromRGB(255, 255, 255), -- White
        TextField = Color3.fromRGB(139, 0, 0),        -- Dark Red
        TextFieldAccent = Color3.fromRGB(255, 255, 255), -- White
    },
    Voidwalker = {
        MainFrame = Color3.fromRGB(25, 0, 50),        -- Dark Purple
        Minimise = Color3.fromRGB(75, 0, 130),        -- Indigo
        MinimiseAccent = Color3.fromRGB(138, 43, 226),-- Blue Violet
        Maximise = Color3.fromRGB(48, 25, 52),        -- Mauve
        MaximiseAccent = Color3.fromRGB(75, 0, 130),  -- Indigo
        NavBar = Color3.fromRGB(0, 0, 0),             -- Black
        NavBarAccent = Color3.fromRGB(255, 255, 255), -- White
        NavBarInvert = Color3.fromRGB(30, 30, 30),    -- Dark Gray
        TitleBar = Color3.fromRGB(75, 0, 130),        -- Indigo
        TitleBarAccent = Color3.fromRGB(255, 255, 255), -- White
        Overlay = Color3.fromRGB(48, 25, 52),         -- Mauve
        Banner = Color3.fromRGB(138, 43, 226),        -- Blue Violet
        BannerAccent = Color3.fromRGB(0, 0, 0),       -- Black
        ...
        Toggle = Color3.fromRGB(147, 112, 219),       -- Medium Purple
        ToggleAccent = Color3.fromRGB(255, 255, 255), -- White
        Dropdown = Color3.fromRGB(25, 0, 50),         -- Dark Purple
        DropdownAccent = Color3.fromRGB(138, 43, 226), -- Blue Violet
        ColorPicker = Color3.fromRGB(75, 0, 130),     -- Indigo
        ColorPickerAccent = Color3.fromRGB(255, 255, 255), -- White
        TextField = Color3.fromRGB(186, 85, 211),     -- Medium Orchid
    ...
    Inferno = {
        MainFrame = Color3.fromRGB(30, 15, 15),       -- Blackened Red
        Minimise = Color3.fromRGB(255, 69, 0),        -- Lava Orange
        MinimiseAccent = Color3.fromRGB(255, 140, 0), -- Dark Orange
        Maximise = Color3.fromRGB(255, 99, 71),       -- Tomato
        MaximiseAccent = Color3.fromRGB(255, 165, 0), -- Orange
        NavBar = Color3.fromRGB(0, 0, 0),             -- Black
        NavBarAccent = Color3.fromRGB(255, 255, 255), -- White
        NavBarInvert = Color3.fromRGB(30, 30, 30),    -- Dark Gray
        TitleBar = Color3.fromRGB(255, 69, 0),        -- Lava Orange
        TitleBarAccent = Color3.fromRGB(255, 255, 255), -- White
        Overlay = Color3.fromRGB(139, 0, 0),          -- Dark Red
        Banner = Color3.fromRGB(255, 69, 0),          -- Lava Orange
        BannerAccent = Color3.fromRGB(255, 255, 255), -- White
        Content = Color3.fromRGB(255, 140, 0),        -- Dark Orange
        Button = Color3.fromRGB(255, 99, 71),         -- Tomato
        ButtonAccent = Color3.fromRGB(255, 255, 255), -- White
        ChipSet = Color3.fromRGB(255, 69, 0),         -- Lava Orange
        ChipSetAccent = Color3.fromRGB(255, 255, 255), -- White
        DataTable = Color3.fromRGB(139, 0, 0),        -- Dark Red
        DataTableAccent = Color3.fromRGB(255, 255, 255), -- White
        Slider = Color3.fromRGB(255, 140, 0),         -- Dark Orange
        SliderAccent = Color3.fromRGB(255, 69, 0),    -- Lava Orange
        Toggle = Color3.fromRGB(255, 99, 71),         -- Tomato
        ToggleAccent = Color3.fromRGB(255, 255, 255), -- White
        Dropdown = Color3.fromRGB(139, 0, 0),         -- Dark Red
        DropdownAccent = Color3.fromRGB(255, 140, 0), -- Dark Orange
        ColorPicker = Color3.fromRGB(255, 69, 0),     -- Lava Orange
        ColorPickerAccent = Color3.fromRGB(255, 255, 255), -- White
        TextField = Color3.fromRGB(255, 99, 71),      -- Tomato
        TextFieldAccent = Color3.fromRGB(255, 255, 255), -- White
    }
}
